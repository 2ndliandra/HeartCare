...
import { LayoutDashboard, HeartPulse, History, MessageSquare, User, Heart, X, ChevronsLeft, ChevronsRight } from "lucide-react"
...
export function UserSidebar({ isMobileOpen, onMobileClose, isCollapsed = false, onToggleCollapse }: UserSidebarProps) {
        ...
        <div className="flex flex-col h-full bg-white">
          ...
          <div className="px-2 flex-1 flex flex-col">
            <div className="space-y-0.5">
              {menuItems.map((item) => {
                const isDashboardRoute = item.route === "/user"
