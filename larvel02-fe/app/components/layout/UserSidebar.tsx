...
import {LayoutDashboard, HeartPulse, History, MessageSquare, User, Heart, X, Menu, LogOut} from "lucide-react"
...
export function UserSidebar({ user, isMobileOpen, onMobileClose }: UserSidebarProps) {
