                ...
                <div className="w-full max-w-md mx-auto">
                    <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-2xl">
                        <div className="mb-8">
                            ...
                            <p className="text-gray-600 text-sm">Join our community and start learning today.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                <label htmlFor="confirm-password" className="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wider">
                                    Confirm Password
                                </label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        <p className="mt-6 text-center text-sm text-gray-600">
                            ...
                            <Link to="/login" className="font-bold text-[#4F7CFF] hover:text-[#6B8FFF] transition-colors">
                                SIGN IN
                            </Link>
                        </p>
                    </div>
